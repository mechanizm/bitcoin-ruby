= ARCHIVED LEGACY FORK

WARNING: This fork is no longer maintained. It is preserved for historical
reference and is read-only. Do not use it for new projects; use it at your own
risk.
